...
export function PostModal({ isModalOpen = false, text, onChange, onSubmit, onImagesSelected, setIsModalOpen }) {
    ...
    return (
        isModalOpen ? (
            <div className="fixed inset-0 z-50 flex items-center justify-center w-full h-full bg-black bg-opacity-80" onClick={() => setIsModalOpen(false)}>
                <div className="relative flex justify-center w-full h-full p-4 top-16">
                    <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center w-[33.33333%] h-fit rounded-2xl bg-neutral-gray" onClick={(e) => e.stopPropagation()}>
