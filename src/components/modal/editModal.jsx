...
export const EditModal = ({ text, onChange, onSubmit, onImagesSelected, isOpen, onClose}) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
            <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center w-[50%] h-fit rounded-2xl bg-neutral-gray">
                <div className="w-[50%] flex flex-col gap-4 py-6">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex flex-col justify-center  border-[#74BDE8] border-2">
